...
const allSeries = {
  ...
  'Charlie Chaplin': { imdb: '' },
  'F. W. Murnau': { imdb: '' },
  'Carl TH. Dreyer': { imdb: '' },
  'Dorothy, Arzner': { imdb: '' },
  'Hitchcock I (1929 - 1941)': { imdb: '' },
  'Fritz Lang': { imdb: '' },
  'Sergei Eisenstein': { imdb: '' },
  'Stanley Kubrick': { imdb: '' },
  'Luchino Visconti': { imdb: '' },
  'Andrei Tarkovsky': { imdb: '' },
  'Francois Truffaut': { imdb: '' },
  'Melvin Van Peebles': { imdb: '' },
  'Hitchcock II (1942 - 1976)': { imdb: '' },
  'Jean Cocteau': { imdb: '' },
  'Ernst Lubitsch': { imdb: '' },
  'Ida Lupino': { imdb: '' },
  'Orson Welles': { imdb: '' },
  'Early Speilberg': { imdb: '' },
  'Dutch Verhoeven': { imdb: '' },
